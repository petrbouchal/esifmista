...
dtl_smpl <- dtl %>% 
  ...
  mutate(obec_puvod = "obec-ZUJ u projektů, kde byly zadány",
  ...
  select(prj_id, op_id, level, level_orig, rozpad_typ, 
         rozpad_duvod, obec_puvod)
```
...
```{r}
dir.create(here::here("data-processed", "dtl_resolved_smpl"))
