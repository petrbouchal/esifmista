...
- chceme obce podle ČSÚ (př. 554728), nebo podle původních dat (př. CZ010554728)?
- formát (XLSX, CSV?)
- podle čeho rozdělovat do souborů, pokud budeme ()
...
- spousta těchto projektů by při pečlivém třídění šla lokalizovat přesněji, ale muselo by se jít projekt po projektu nebo alespoň výzvu po výzvě, kde ale výzva může být jen několik desítek projektů (velké výzvy jsou v našich rozpadech rozpoznané a ošetřené)
